...
const Page = () => {
    ...
    return (
        ...
        /* انیمیشن خروج به چپ (برای next) */
        .slide-exit-left {
          animation: slideExitLeft 0.3s forwards;
        }
        /* انیمیشن ورود از راست (برای next) */
        .slide-enter-right {
          animation: slideEnterRight 0.3s forwards;
        }
        /* انیمیشن خروج به راست (برای prev) */
        .slide-exit-right {
          animation: slideExitRight 0.3s forwards;
        }
        /* انیمیشن ورود از چپ (برای prev) */
        .slide-enter-left {
      ...
      `}</style>
            ...
            <div className="rtl p-4 max-w-7xl mx-auto space-y-6">
                {/* حذف input تاریخ */}
                ...
                <div className="font-semibold text-gray-800">
                    ...
                    {workTimes.map((range, index) => (
                        <span
                            key={index}
                            className="mr-3 inline-block text-sm text-gray-600"
                        >
                ...
                {/* نمایش تاریخ‌ها */}
                <div
                    className={`flex gap-4 overflow-hidden ${animationClass}`}
                ...
                >
                    {pagedDates.map((date) => (
                        ...
                        >
                            <div className="bg-blue-600 text-white text-center py-2 rounded-t-lg font-semibold text-base select-none">
                                {date.jalali}
                            </div>

                            <div
                                className="flex flex-col gap-2 p-3 overflow-y-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-300 max-h-[350px]"
